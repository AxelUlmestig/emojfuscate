...
impl<'a, I> DecodeEmojiToBytes<'a, I>
where
    I: Iterator<Item = u8>,
{
...
// implementations
impl<'a, I> Iterator for DecodeEmojiToBytes<'a, I>
where
    I: Iterator<Item = u8>,
{
...
impl<'a> IsEmojiRepresentation<i64> for String {
    fn demojfuscate_stream(&mut self) -> DecodeEmojiToBytes<i64> {
        self.as_bytes().iter_mut().demojfuscate_stream()
    }
}
*/
...
//
// pub struct EmojfuscateIterator<A, I>
// where
//     I: Iterator<Item = u8>,
//     A: ConstructFromEmoji<A, I>,
// {
...
// }
//
// impl<A, I> Iterator for EmojfuscateIterator<A, I>
// where
//     I: Iterator<Item = u8>,
//     A: ConstructFromEmoji<A, I>,
// {
...
//         }
//
//         match A::construct_from_emoji(self.iter) {
//             Ok((element, new_byte_stream)) => {
//                 self.iter = new_byte_stream;
